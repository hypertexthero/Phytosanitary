...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Category.description_html'
        db.add_column('phytosanitary_category', 'description_html', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Category.description_html'
        db.delete_column('phytosanitary_category', 'description_html')
    ...
    models = {
        ...
        'phytosanitary.myprofile': {
            'Meta': {'ordering': "['user']", 'object_name': 'MyProfile'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
