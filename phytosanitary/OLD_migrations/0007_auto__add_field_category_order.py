...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('phytosanitary_category', 'order', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Category.order'
        db.delete_column('phytosanitary_category', 'order')
