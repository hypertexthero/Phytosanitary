...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('coltrane_userprofile', 'url', self.gf('django.db.models.fields.URLField')(default=datetime.date(2012, 2, 15), max_length=200), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.url'
        db.delete_column('coltrane_userprofile', 'url')
